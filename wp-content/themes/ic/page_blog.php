	...
	<div id="rooms" class="section">
		...
		<?php  $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
		        ...
		        ?>
					...
					<li class="room-box">
						<a href="<?php the_permalink(); ?>"><div class="fl" style="background-image: url(<?php if(get_post_meta($post->ID, 'cebo_homethumb', true)) { ?><?php echo tt(get_post_meta($post->ID, 'cebo_homethumb', true), 400, 330); ?><?php } else { ?><?php echo tt($imgsrc[0], 400, 330); ?><?php } ?>);"></div></a>
