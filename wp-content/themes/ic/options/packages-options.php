...
add_action('admin_menu', 'packages_type_add_box');
// Add meta box
function packages_type_add_box() {
	global $meta_box;
	foreach ( array( 'packages' ) as $page )
	add_meta_box($meta_box['id'], $meta_box['title'], 'packages_type_show_box', $page, $meta_box['context'], 			$meta_box['priority']);
}
// Callback function to show fields in meta box
function packages_type_show_box() {
...
jQuery(document).ready(function() {
	...
	echo '<input type="hidden" name="packages_type_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
...
add_action('save_post', 'packages_type_save_data');
// Save data from meta box
function packages_type_save_data($post_id) {
	global $meta_box;	
	// verify nonce
	if (!wp_verify_nonce($_POST['packages_type_meta_box_nonce'], basename(__FILE__))) {
		return $post_id;
	}
	// check autosave
