...
{
	$sURL = 'https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyD28F-07gRmSGF4SwEo-7iIFyxJxQovKSQ&address='.urlencode($sQuery).'&region='.$sCountry.'&language='.$sCountry;
