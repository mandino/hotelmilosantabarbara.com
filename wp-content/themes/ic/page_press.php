...
<div class="fullpic">
	...
	<div class="slide-header">
		<a class="button" target="_blank" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>" onclick="ga('send', 'event', 'reserve-now', 'click','reserve-button-banner'); fbq('track', 'InitiateCheckout'); _gaq.push(['_link', this.href]);return false;"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
	</div>
	...
	<div id="page-content" class="section">
		...
		<div class="container">
			...
			<div class="post-content fl" style="width: 100%; border-right: none; padding-top: 20px; padding-right: 0; padding-left: 0;">
				...
				<?php query_posts('cat=10&posts_per_page=-1'); if(have_posts()) : while(have_posts()) : the_post(); $imgsrc = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "Full"); ?>
