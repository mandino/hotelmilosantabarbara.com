			...
			<div class="ressys">
				...
				<!-- flex dates -->
					...
					<div class="reservationform flexdate">
						...
						<p><a href="https://hotelmilosantabarbara.reztrip.com" onclick="ga('send', 'event', 'Booking-widget', 'click', 'Flexible Dates');">Flexible dates?</a> Search for our best available rate</p>
