					...
					<li class="room-box">
						<div class="fl">
							...
							<?php } else { ?>
								...
								<img src="<?php echo tt($imgsrc[0], 557, 400); ?>" alt="<?php echo get_custom_image_thumb_alt_text('',$post->ID); ?>">
						...
						<div class="fr">
							...
							<div class="room-list-buttons">
								...
								<a class="button" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>" target="_blank" onclick="fbq('track', 'InitiateCheckout'); _gaq.push(['_link', this.href]);return false;">Reserve Now</a>
