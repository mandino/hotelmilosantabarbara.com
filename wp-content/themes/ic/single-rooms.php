		...
		<div class="container">
			...
			<div class="room-details-content">
				...
				<div class="sidebar room-details-gallery fr">
					...
					<a class="button" target="_blank" onclick="fbq('track', 'InitiateCheckout');" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>">RESERVE NOW</a>
