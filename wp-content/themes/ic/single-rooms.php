			...
			<ul class="slides">
				<li>
					...
					<div class="slide-header">
						<a class="button" target="_blank" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>" onclick="ga('send', 'event', 'reserve-now', 'click','reserve-button-slider-single-rooms'); fbq('track', 'InitiateCheckout'); _gaq.push(['_link', this.href]);return false;"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
					</div>
		...
		<div class="container">
			...
			<div class="room-details-content">
				...
				<div class="sidebar room-details-gallery fr">
					...
					<a class="button" target="_blank" onclick="ga('send', 'event', 'reserve-now', 'click','reserve-button-single-room'); fbq('track', 'InitiateCheckout');" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>">RESERVE NOW</a>
