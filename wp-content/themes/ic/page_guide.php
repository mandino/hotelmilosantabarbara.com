 ...
 get_header(); ?>
 	...
 	<?php if (is_page(45)) { ?>
	  	...
	  	<ul class="right-links right" id="toggles">
			<li class="dine"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>eat/'" href="<?php echo get_permalink( $post->post_parent ); ?>eat/" class="linkerd2 active" data-pins="<?php bloginfo('url'); ?>/?page_id=48" title="Eat">Eat</a></li>
			<li class="shop"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>shop/'" href="<?php echo get_permalink( $post->post_parent ); ?>shop/" class="linkerd2 active" data-pins="<?php bloginfo('url'); ?>/?page_id=68" title="Shop">Shop</a></li>
			<li class="arts"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>culture/'" href="<?php echo get_permalink( $post->post_parent ); ?>culture/" class="linkerd2 active" data-pins="<?php bloginfo('url'); ?>/?page_id=66" title="Culture">Culture</a></li>
			<li class="sights"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>landmarks/'" href="<?php echo get_permalink( $post->post_parent ); ?>landmarks/" class="linkerd2 active" data-pins="<?php bloginfo('url'); ?>/?page_id=160" title="Landmarks">Landmarks</a></li>
		</ul>
	...
	?>
		...
		<ul class="right-links right" id="toggles">
			<li class="dine"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>eat/'" href="<?php echo get_permalink( $post->post_parent ); ?>eat/" data-id="eatl" class="linkerd <?php if ($com_link == 'eat') { ?>active<?php } ?>" data-pins="<?php bloginfo('url'); ?>/?page_id=48" title="Dining">Eat</a></li>
			<li class="shop"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>shop/'" href="<?php echo get_permalink( $post->post_parent ); ?>shop/" data-id="shopl" class="linkerd <?php if ($com_link == 'shop') { ?>active<?php } ?>" data-pins="<?php bloginfo('url'); ?>/?page_id=68" title="Dining">Shop</a></li>
			<li class="arts"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>culture/'" href="<?php echo get_permalink( $post->post_parent ); ?>culture/" data-id="cult" class="linkerd <?php if ($com_link == 'culture') { ?>active<?php } ?>" data-pins="<?php bloginfo('url'); ?>/?page_id=66" title="Dining">Culture</a></li>
			<li class="sights"><a onClick="location.href='<?php echo get_permalink( $post->post_parent ); ?>landmarks/'" href="<?php echo get_permalink( $post->post_parent ); ?>landmarks/" data-id="landl" class="linkerd <?php if ($com_link == 'landmarks') { ?>active<?php } ?>" data-pins="<?php bloginfo('url'); ?>/?page_id=160" title="Dining">Landmarks</a></li>
		</ul>
				...
				<div class="fr viewall">
					...
					<ul id="upcoming-events">
						...
						<li<?php if($count == 2 || $count == 4) { ?> class="even"<?php } ?>>
							<a href="<?php the_permalink(); ?>"><img src="<?= $imgsrc[0]; ?>"  alt='<?php echo get_custom_image_thumb_alt_text('', $post->ID); ?>'/>
				...
				<div class="whats-hot">
					...
					<div>
						<ul>
							...
							<?php query_posts('post_type=post&posts_per_page=2&offset=1&cat=-10'); if(have_posts()) : while(have_posts()) : the_post(); $imgsrc = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "large"); ?>

							<li>
								<a href="<?php the_permalink(); ?>"><img src='<?= $imgsrc[0]; ?>' alt='<?php the_title(); ?>' /></a>
						...
						<?php query_posts('post_type=post&posts_per_page=1&cat=-10'); if(have_posts()) : while(have_posts()) : the_post(); $imgsrc = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "large"); ?>
							<li>
								<a href="<?php the_permalink(); ?>"><img src='<?= $imgsrc[0]; ?>' alt='<?php the_title(); ?>' /></a>
						...
						<ul>
							...
							<?php query_posts('post_type=post&posts_per_page=2&offset=3&cat=-10'); if(have_posts()) : while(have_posts()) : the_post(); $imgsrc = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), "large"); ?>
