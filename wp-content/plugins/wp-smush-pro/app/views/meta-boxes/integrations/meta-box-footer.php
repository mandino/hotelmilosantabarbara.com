...
<div class="sui-actions-right">
	<span class="wp-smush-submit-wrap">
		<input type="submit" id="wp-smush-save-settings" class="sui-button sui-button-primary" aria-describedby="smush-submit-description" value="<?php esc_attr_e( 'UPDATE SETTINGS', 'wp-smushit' ); ?>" <?php disabled( ! $show_submit, true, false ); ?>>
