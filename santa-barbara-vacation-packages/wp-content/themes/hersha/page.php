...
<div class="fullpic">
	...
	<div class="slide-header">
		<a class="button" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>" onclick="_gaq.push(['_trackEvent', 'Reserve', 'Reservation-button-banner', 'Reserve Now']);"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
	</div>
	...
	<div id="page-content" class="section">
		...
		<div class="container">
			...
			<div class="sidebar fr">
				...
				<a class="button" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>" onclick="_gaq.push(['_trackEvent', 'Reserve', 'Reservation-button-sidebar', 'Reserve Now']);"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
