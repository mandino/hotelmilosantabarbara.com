...
// $pages_array = get_posts(array('post_type' => 'hotels'));
$terms = array();
$site_pages = array(
...
$meta_boxer = array(
	...
	'fields' => array(
		...
		array( 
			"name" => "Publish to Booking Widget",
			"id" => $prefix."_to_widget",
			"type" => "checkbox",
			"std" => ""
		),
		...
		array( 
 		...
 		array( 
	          ...
	          "desc" => "This thumb should be panoramic. A good size is 712w X 300h. ",
	          "id" => $prefix."_sliderthumb",
	          "type" => "upload",
	          "std" => ""
              ),		
 		...
 		array( 
              "name" => "Link for reason to stay here 1",
	          "id" => $prefix."_reasonlink1",
	          "type" => "text",
	          "std" => ""
              ),

 		array( 
              "name" => "Reason to stay here 2",
	          "id" => $prefix."_reason2",
	          "type" => "text",
	          "std" => ""
              ),
 		...
 		array( 
              "name" => "Link for Reason to stay here 2",
	          "id" => $prefix."_reasonlink2",
	          "type" => "text",
	          "std" => ""
              ),

 		array( 
              "name" => "Reason to stay here 3",
	          "id" => $prefix."_reason3",
	          "type" => "text",
	          "std" => ""
              ),
 		...
 		array( 
              "name" => "Link for Reason to stay here 3",
	          "id" => $prefix."_reasonlink3",
	          "type" => "text",
	          "std" => ""
              ),

 		array( 
              "name" => "Reason to stay here 4",
	          "id" => $prefix."_reason4",
	          "type" => "text",
	          "std" => ""
              ),
 		...
 		array( 
              "name" => "Link for Reason to stay here 4",
	          "id" => $prefix."_reasonlink4",
	          "type" => "text",
	          "std" => ""
              ),
